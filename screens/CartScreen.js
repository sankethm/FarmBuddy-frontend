import { StyleSheet, Text, View,ScrollView,Pressable,Platform,TextInput,Image } from 'react-native'
...
const total = cart
    ?.map((item) => parseInt(item.price) * (1-parseInt(item.discount)/100) * item.quantity)
