      ...
      <Tab.Navigator>
        ...
        <Tab.Screen
          ...
          options={{
            ...
            tabBarIcon: ({ focused }) =>
              focused ? (
                <Ionicons name="bag-add" size={24} color="#008E97" />
              ) : (
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        ...
        <Stack.Screen name="AdminProduct" component={AdminProductListScreen} options={{ headerShown: false }} />
        <Stack.Screen name="DeleteProduct" component={DeleteProductScreen} options={{ headerShown: false }} />
